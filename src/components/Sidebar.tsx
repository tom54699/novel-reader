        ...
        {docs.map((doc: any) => (
          <li key={doc.id}>
            ...
            >
              ...
              {doc.id === activeId && Array.isArray(activeDoc?.chapters) && activeDoc.chapters.length > 0 ? (
                <span
            ...
            {activeDoc && doc.id === activeDoc.id && Array.isArray(activeDoc.chapters) && activeDoc.chapters.length > 0 && !collapsed[doc.id] && (
